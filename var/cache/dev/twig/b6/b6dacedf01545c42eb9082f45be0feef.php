...
class __TwigTemplate_a4c4c21f9cf1fab6634f8ac5639982d0 extends Template
{
...
";
    ...
    <fieldset>
        ...
        // line 24
        if ((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 24, $this->source); })()), "content", [], "any", false, false, false, 24), "vars", [], "any", false, false, false, 24), "valid", [], "any", false, false, false, 24)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield "has-error";
        }
        yield "\">
            ";
...
";
    ...
    {
        return array (  112 => 40,  103 => 36,  95 => 31,  91 => 30,  85 => 28,  80 => 25,  74 => 24,  68 => 22,  60 => 18,  55 => 15,  51 => 9,  48 => 8,);
    }
