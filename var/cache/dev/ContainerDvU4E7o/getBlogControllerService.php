...
class getBlogControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Txvfrx4'] ?? $container->load('get_ServiceLocator_Txvfrx4Service'))->withContext('App\\Controller\\Admin\\BlogController', $container));
