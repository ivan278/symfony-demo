...
class getUx_LiveComponent_ComponentHydratorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['ux.live_component.metadata_factory'] ?? self::getUx_LiveComponent_MetadataFactoryService($container));
        ...
        }, 1), ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container)), $a, NULL, $container->getEnv('APP_SECRET'), $b);
    }
}
